resource "azurerm_virtual_network" "example" {
  ...
  tags = {
    ...
    git_repo             = "terragoat"
    yor_trace            = "ee94d0ca-4dac-4ad9-beb2-bb5e0f04d96c"
  }
}
...
resource "azurerm_network_interface" "ni_linux" {
  ...
  tags = {
    ...
    git_org              = "try-bridgecrew"
    git_repo             = "terragoat"
    yor_trace            = "eb34f9b2-2c1d-47ec-a6bd-4268350b87d4"
  }
}
...
resource "azurerm_network_interface" "ni_win" {
  ...
  tags = {
    ...
    git_org              = "try-bridgecrew"
    git_repo             = "terragoat"
    yor_trace            = "617b6522-7781-4c1a-9b6f-5100988d5a27"
  }
}
...
resource azurerm_network_security_group "bad_sg" {
  ...
  tags = {
    ...
    git_org              = "try-bridgecrew"
    git_repo             = "terragoat"
    yor_trace            = "d04b60a0-8f5b-42aa-b67c-a23fe85ede32"
  }
}
...
resource azurerm_network_watcher "network_watcher" {
  ...
  tags = {
    ...
    git_org              = "try-bridgecrew"
    git_repo             = "terragoat"
    yor_trace            = "be5b1a0c-bcf2-4665-9b1e-5cb0686d60a0"
  }
}
